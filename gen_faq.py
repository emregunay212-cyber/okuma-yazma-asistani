...
IMLA = {
    ...
    "orijinal": "orjinal", "ya da": "yada", "bugün": "bu gün",
    "gökyüzü": "gök yüzü", "fark etmez": "farketmez", "herhangi bir": "herhangibir",
    "traktör": "tıraktör",
}
...
KURALLAR = [
    ...
    ("noktalı virgül nedir",
     "**Noktalı virgül (;)** virgülle ayrılmış grupları ya da anlamca bağlı cümleleri birbirinden ayırır. 😊",
     None, ["noktalı virgül"], None),
    ("cümle sonuna hangi işaret konur",
     "Cümlenin sonuna anlamına göre **nokta (.)**, **soru işareti (?)** ya da **ünlem (!)** konur. 😊",
     None, None, ["cümle sonu", "cümlenin sonu", "kelimenin sonuna", "sonuna hangi", "sona hangi", "hangi işaret kon"]),
